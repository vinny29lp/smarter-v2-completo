...
git add \
  ...
  "app/dashboard/estudantes/[id]/page.tsx" \
  "app/api/app/contratos/[id]/route.ts" \
  "app/api/app/franqueados/[id]/route.ts" \
  "app/dashboard/franqueados/[id]/page.tsx"
...
echo ""
echo "🚀 Criando commit..."
git commit -m "fix: corrigir exclusão de estudante, sincronizar status EM_ESTAGIO e adicionar exclusão de franqueado"
